        ...
        <div className={style["boxBx"]}>
            <div className={style["box"]}>
                ...
                <div className={style["content"]}>
                    <h4><span> 1. </span> FORZA HORIZON 5</h4>
            ...
            <div className={style["box"]}>
                {<img src={img12} alt="" />}
                <div className={style["content"]}>
                    <h4><span> 3. </span> ASPHALT LEGENDS</h4>
